...
import erickfilho.controller.AlunoController;
import erickfilho.controller.ProfessorController;
import erickfilho.controller.ViacepController;
import erickfilho.model.domain.Aluno;
import erickfilho.model.domain.Endereco;
import erickfilho.model.domain.Professor;
import erickfilho.service.AlunoService;
import erickfilho.service.ProfessorService;
import spark.Spark;
...
public class App {
    ...
    private static void incluirAlunosIniciais() {
        ...
        String[] nomes = {"Erick", "Eduardo", "Thalyson", "Bernardo"};
        String[] ceps = {"23017390", "02874030", "23017390", "23017390"};
